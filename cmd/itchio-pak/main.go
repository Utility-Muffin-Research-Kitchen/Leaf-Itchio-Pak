...
func main() {
	...
	catInput := flag.String("cat-input", "", "run an offline Catastrophe input fixture: filter, detail, warning, download-select, download-progress, download-done, download-error, download-inhibit, download-cancelled, or download-handoff")
